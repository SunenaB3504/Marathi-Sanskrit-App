...
const S4_QUIZ = {
  id: "S4-QUIZ",
  title: "Sanskrit Phase 4: Stories & Heritage",
  description: "Test your knowledge of Panchatantra stories and Indian Epics!",
  totalQuestions: 30,
  questions: [
    { id: "s4-q1", type: "mcq", question: "In the story 'The Crow and the Pitcher', what did the crow drop into the pot?", options: ["Leaves", "Pebbles/Stones", "Sand", "Feathers"], answer: "Pebbles/Stones" },
    { id: "s4-q2", type: "mcq", question: "What is the Sanskrit word for 'Thirsty'?", options: ["तृषितः", "बुद्धिः", "जलम्", "काकः"], answer: "तृषितः" },
    { id: "s4-q3", type: "mcq", question: "The moral 'Effort, not wishes, achieves tasks' is from which story?", options: ["Monkey & Crocodile", "Crow & Pitcher", "Lion & Hare", "Ramayana"], answer: "Crow & Pitcher" },
    { id: "s4-q4", type: "mcq", question: "In 'The Monkey and the Crocodile', what did the crocodile's wife want to eat?", options: ["Mangoes", "The Monkey's heart", "Fish", "The Monkey's brain"], answer: "The Monkey's heart" },
    { id: "s4-q5", type: "mcq", question: "What does 'मकरः' mean?", options: ["Monkey", "Crocodile", "Lion", "Rabbit"], answer: "Crocodile" },
    { id: "s4-q6", type: "mcq", question: "How did the monkey outsmart the crocodile?", options: ["He swam away", "He said he left his heart on the tree", "He called his friends", "He hid in a cave"], answer: "He said he left his heart on the tree" },
    { id: "s4-q7", type: "mcq", question: "In 'The Lion and the Hare', where did the hare take the lion?", options: ["To a cave", "To a deep well", "To a mountain", "To a river"], answer: "To a deep well" },
    { id: "s4-q8", type: "mcq", question: "What did the lion see in the well?", options: ["Another lion", "His own reflection", "A treasure", "The hare's family"], answer: "His own reflection" },
    { id: "s4-q9", type: "mcq", question: "Who was the 'Adikavi' (First Poet) of the Ramayana?", options: ["Vyasa", "Valmiki", "Kalidasa", "Tulsidas"], answer: "Valmiki" },
    { id: "s4-q10", type: "mcq", question: "The Mahabharata is said to be how many times longer than the Iliad/Odyssey combined?", options: ["2 times", "5 times", "10 times", "100 times"], answer: "10 times" },
    { id: "s4-q11", type: "mcq", question: "What does the name 'Arjuna' mean?", options: ["Strong", "Bright/Clear/Silver", "Dark", "Steadfast"], answer: "Bright/Clear/Silver" },
    { id: "s4-q12", type: "mcq", question: "Which epic contains the 'Bhagavad Gita'?", options: ["Ramayana", "Mahabharata", "Panchatantra", "Vedas"], answer: "Mahabharata" },
    { id: "s4-q13", type: "mcq", question: "What is a 'Subhashita'?", options: ["A long poem", "A witty wise saying", "A grammar book", "A map"], answer: "A witty wise saying" },
    { id: "s4-q14", type: "mcq", question: "Translate 'सत्यं ब्रूयात् प्रियं ब्रूयात्'?", options: ["Speak truth, speak what is pleasing", "Knowledge is power", "Always be brave", "Help your friends"], answer: "Speak truth, speak what is pleasing" },
    { id: "s4-q15", type: "mcq", question: "Who wrote the 'Panchatantra'?", options: ["Valmiki", "Vishnu Sharma", "Vyasa", "Chanakya"], answer: "Vishnu Sharma" },
    { id: "s4-q16", type: "mcq", question: "What does 'वानरः' mean?", options: ["Crocodile", "Monkey", "Rabbit", "Crow"], answer: "Monkey" },
    { id: "s4-q17", type: "mcq", question: "In the crow story, 'कलशः' means:", options: ["Water", "Pot/Pitcher", "Stone", "Sky"], answer: "Pot/Pitcher" },
    { id: "s4-q18", type: "mcq", question: "Which character's name means 'Steadfast in Battle'?", options: ["Arjuna", "Yudhishthira", "Krishna", "Bhima"], answer: "Yudhishthira" },
    { id: "s4-q19", type: "mcq", question: "The word 'Yoga' entered English directly from which language?", options: ["Latin", "Sanskrit", "Greek", "French"], answer: "Sanskrit" },
    { id: "s4-q20", type: "mcq", question: "What does 'Janani Janmabhumishcha' mean?", options: ["Mother and Motherland", "Peace and Love", "Work is Worship", "Truth always wins"], answer: "Mother and Motherland" },
    { id: "s4-q21", type: "mcq", question: "'Buddhir-balavati sada' means:", options: ["Strength is the only power", "Intelligence is always stronger", "Be kind to everyone", "Time is precious"], answer: "Intelligence is always stronger" },
    { id: "s4-q22", type: "mcq", question: "Which bird represents 'Focus' in a Subhashita?", options: ["Crow", "Heron (Baka)", "Owl", "Peacock"], answer: "Heron (Baka)" },
    { id: "s4-q23", type: "mcq", question: "What does 'Sinha-pura' (Singapore) mean?", options: ["Garden City", "Lion City", "Trading Port", "Holy City"], answer: "Lion City" },
    { id: "s4-q24", type: "mcq", question: "The Ramayana is the legacy of which sage?", options: ["Vyasa", "Valmiki", "Agastya", "Vashishta"], answer: "Valmiki" },
    { id: "s4-q25", type: "mcq", question: "What is the core message of 'Karmanye vadhikaraste'?", options: ["Do your duty without attachment to results", "Always seek wealth", "Be the best at everything", "Never work hard"], answer: "Do your duty without attachment to results" },
    { id: "s4-q26", type: "mcq", question: "The crow was 'तृषितः'. What does that feel like?", options: ["Hungry", "Thirsty", "Sleepy", "Happy"], answer: "Thirsty" },
    { id: "s4-q27", type: "mcq", question: "Who outsmarted a mighty lion?", options: ["A monkey", "A tiny hare (rabbit)", "A bird", "A fish"], answer: "A tiny hare (rabbit)" },
    { id: "s4-q28", type: "mcq", question: "What is 'प्रतिबिम्बम्'?", options: ["A story", "A reflection", "A stone", "A tree"], answer: "A reflection" },
    { id: "s4-q29", type: "mcq", question: "Sanskrit relates to English through which family?", options: ["Dravidian", "Indo-European", "Semitic", "Sino-Tibetan"], answer: "Indo-European" },
    { id: "s4-q30", type: "mcq", question: "A 'Subhashita' is 'Well-_______'?", options: ["Written", "Spoken", "Born", "Done"], answer: "Spoken" }
  ]
};

const M3_QUIZ = {
  id: "M3-QUIZ",
  title: "Marathi Phase 3: Grammar & Sentences",
  description: "Test your skills in Marathi sentence patterns, tenses, and conversations!",
  totalQuestions: 30,
  questions: [
    { id: "m3-q1", type: "mcq", question: "What is the standard word order in a Marathi sentence?", options: ["SVO (Subject-Verb-Object)", "SOV (Subject-Object-Verb)", "VSO", "OVS"], answer: "SOV (Subject-Object-Verb)" },
    { id: "m3-q2", type: "mcq", question: "Translate 'I read a book' into Marathi correctly:", options: ["मी वाचते पुस्तक।", "मी पुस्तक वाचते।", "पुस्तक मी वाचते।", "वाचते मी पुस्तक।"], answer: "मी पुस्तक वाचते।" },
    { id: "m3-q3", type: "mcq", question: "Which possessive suffix is used for 'My' with a feminine object?", options: ["माझा", "माझी", "माझे", "माझं"], answer: "माझी" },
    { id: "m3-q4", type: "mcq", question: "How do you say 'Father's house'?", options: ["बाबा घर", "बाबाचे घर", "बाबाचा घर", "बाबाला घर"], answer: "बाबाचे घर" },
    { id: "m3-q5", type: "mcq", question: "What does 'मी जाते' mean?", options: ["I go (male)", "I go (female)", "We go", "They go"], answer: "I go (female)" },
    { id: "m3-q6", type: "mcq", question: "Translate 'Yesterday I went to school':", options: ["आज मी शाळेत जाते।", "काल मी शाळेत गेले।", "उद्या मी शाळेत जाईन।", "मी शाळेत आहे।"], answer: "काल मी शाळेत गेले।" },
    { id: "m3-q7", type: "mcq", question: "What is the future tense of 'to come' (येणे) for 'I'?", options: ["आलो", "येते", "येईन", "येतो"], answer: "येईन" },
    { id: "m3-q8", type: "mcq", question: "Which question word means 'Where'?", options: ["काय", "कुठे", "कोण", "केव्हा"], answer: "कुठे" },
    { id: "m3-q9", type: "mcq", question: "How do you ask 'What happened?'", options: ["कोण झालं?", "कुठे झालं?", "काय झालं?", "कसे झालं?"], answer: "काय झालं?" },
    { id: "m3-q10", type: "mcq", question: "What does 'किती' mean?", options: ["How many / How much", "When", "Why", "Where"], answer: "How many / How much" },
    { id: "m3-q11", type: "mcq", question: "How do you say 'How are you?' (respectfully)?", options: ["तू कसा आहेस?", "तुम्ही कसे आहात?", "काय करतोय?", "कुठे चाललाय?"], answer: "तुम्ही कसे आहात?" },
    { id: "m3-q12", type: "mcq", question: "Which phrase means 'I want water'?", options: ["मला पाणी आवडते।", "मला पाणी हवे आहे।", "मला पाणी वाटते।", "मी पाणी पितो।"], answer: "मला पाणी हवे आहे।" },
    { id: "m3-q13", type: "mcq", question: "What does 'मला आवडते' mean?", options: ["I want", "I like", "I think", "I am going"], answer: "I like" },
    { id: "m3-q14", type: "mcq", question: "How do you say 'I don't go'?", options: ["मी जात नाही।", "मी जाणार नाही।", "मी गेलो नाही।", "मी नको जाते।"], answer: "मी जात नाही।" },
    { id: "m3-q15", type: "mcq", question: "What is the difference between 'नाही' and 'नको'?", options: ["No difference", "Nahi = not so, Nako = don't want", "Nahi is past, Nako is future", "Nahi is for boys, Nako is for girls"], answer: "Nahi = not so, Nako = don't want" },
    { id: "m3-q16", type: "mcq", question: "How do you politely ask for someone to come?", options: ["ये!", "या!", "कृपया या!", "चाल!"], answer: "कृपया या!" },
    { id: "m3-q17", type: "mcq", question: "Translate 'Excuse me/Sorry' into Marathi:", options: ["धन्यवाद", "माफ करा", "कृपया", "स्वागत आहे"], answer: "माफ करा" },
    { id: "m3-q18", type: "mcq", question: "Which construction means 'I think today it will rain'?", options: ["मला वाटते की आज पाऊस येईल।", "मला पाऊस आवडतो।", "मला पाऊस हवा आहे।", "आज पाऊस पडला।"], answer: "मला वाटते की आज पाऊस येईल।" },
    { id: "m3-q19", type: "mcq", question: "In Marathi, the verb often agrees with the ________ in past tense:", options: ["Subject", "Object", "Adverb", "Noun"], answer: "Object" },
    { id: "m3-q20", type: "mcq", question: "How do you say 'My brother'?", options: ["माझा भाऊ", "माझी भाऊ", "माझे भाऊ", "भाऊ माझा"], answer: "माझा भाऊ" },
    { id: "m3-q21", type: "mcq", question: "What does 'कधी' or 'केव्हा' mean?", options: ["Where", "Whom", "When", "Why"], answer: "When" },
    { id: "m3-q22", type: "mcq", question: "How do you say 'Thank you'?", options: ["नमस्ते", "धन्यवाद", "पुनश्च भेटू", "सुस्वागतम"], answer: "धन्यवाद" },
    { id: "m3-q23", type: "mcq", question: "Translate 'Please help me':", options: ["मला मदत करा।", "कृपया मला मदत कराल का?", "मी मदत करतो।", "मदत नको।"], answer: "कृपया मला मदत कराल का?" },
    { id: "m3-q24", type: "mcq", question: "What is the Marathi word for 'Table' (usually borrowed)?", options: ["मेज़", "टेबल", "पाट", "खुर्ची"], answer: "टेबल" },
    { id: "m3-q25", type: "mcq", question: "How do you say 'I live in Mumbai'?", options: ["मी मुम्बई ला जातो।", "अहम् मुम्बई वसामि।", "मी मुम्बई मध्ये राहतो/वसतो।", "मुम्बई माझे घर आहे।"], answer: "मी मुम्बई मध्ये राहतो/वसतो।" },
    { id: "m3-q26", type: "mcq", question: "The suffix 'ला' in 'शाळेला' means:", options: ["Of", "To", "From", "In"], answer: "To" },
    { id: "m3-q27", type: "mcq", question: "What is the opposite of 'हो' (Yes)?", options: ["का", "नाही", "नको", "कसे"], answer: "नाही" },
    { id: "m3-q28", type: "mcq", question: "How do you say 'What time is it?'", options: ["किती वाजले?", "वेळ काय आहे?", "सकाळ झाली का?", "केव्हा येशील?"], answer: "किती वाजले?" },
    { id: "m3-q29", type: "mcq", question: "Which word means 'Of' or 'Belonging to'?", options: ["ला", "चा/ची/चे", "ने", "तून"], answer: "चा/ची/चे" },
    { id: "m3-q30", type: "mcq", question: "In 'Mala aamba avadto', 'aamba' is masculine. What if it was 'shaala' (feminine)?", options: ["आवडतो", "आवडते", "आवडतं", "आवडला"], answer: "आवडते" }
  ]
};

const M4_QUIZ = {
  id: "M4-QUIZ",
  title: "Marathi Phase 4: Stories & Culture",
  description: "Test your knowledge of Marathi folk tales, saints, songs, and history!",
  totalQuestions: 30,
  questions: [
    { id: "m4-q1", type: "mcq", question: "Which great saint-poet wrote the 'Dnyaneshwari'?", options: ["Sant Tukaram", "Sant Dnyaneshwar", "Sant Eknath", "Sant Namdev"], answer: "Sant Dnyaneshwar" },
    { id: "m4-q2", type: "mcq", question: "What is an 'Abhanga'?", options: ["A long story", "A short rhythmic devotional poem", "A type of food", "A historical fort"], answer: "A short rhythmic devotional poem" },
    { id: "m4-q3", type: "mcq", question: "Where did Sant Tukaram live?", options: ["Pune", "Dehu", "Alandi", "Paithan"], answer: "Dehu" },
    { id: "m4-q4", type: "mcq", question: "What does 'Abhanga' mean literally?", options: ["Beautiful", "Unbreakable", "Divine", "People's voice"], answer: "Unbreakable" },
    { id: "m4-q5", type: "mcq", question: "Who made Marathi the official language of his government in the 17th century?", options: ["Aurangzeb", "Chhatrapati Shivaji Maharaj", "Bajirao I", "Sambhaji Maharaj"], answer: "Chhatrapati Shivaji Maharaj" },
    { id: "m4-q6", type: "mcq", question: "What was the 'Rajyavyavahar Kosha'?", options: ["A law book", "A language dictionary/glossary", "A map of Maharashtra", "A collection of songs"], answer: "A language dictionary/glossary" },
    { id: "m4-q7", type: "mcq", question: "Match the fort: Sinhagad means ________ mountain.", options: ["King's", "Lion's", "Courageous", "Silent"], answer: "Lion's" },
    { id: "m4-q8", type: "mcq", question: "What is a 'Lavani'?", options: ["A lullaby", "An energetic Marathi folk dance-song", "A prayer", "A story"], answer: "An energetic Marathi folk dance-song" },
    { id: "m4-q9", type: "mcq", question: "What is the Marathi word for 'Lullaby'?", options: ["लोकगीत", "अंगाईगीत (Angaaigeet)", "पोवाडा", "भजन"], answer: "अंगाईगीत (Angaaigeet)" },
    { id: "m4-q10", type: "mcq", question: "Who sang 'Ovis' while grinding grain?", options: ["Soldiers", "Women at home", "Saints", "Children"], answer: "Women at home" },
    { id: "m4-q11", type: "mcq", question: "A 'Powada' is a ________ ballad.", options: ["Romantic", "Heroic/Historical", "Sad", "Funny"], answer: "Heroic/Historical" },
    { id: "m4-q12", type: "mcq", question: "What did Sant Dnyaneshwar make accessible to ordinary people?", options: ["The Quran", "The Bhagavad Gita (as Dnyaneshwari)", "The Bible", "The Ramayana"], answer: "The Bhagavad Gita (as Dnyaneshwari)" },
    { id: "m4-q13", type: "mcq", question: "Shivaji replaced Persian terms with words from which ancient language?", options: ["English", "Sanskrit", "Latin", "Greek"], answer: "Sanskrit" },
    { id: "m4-q14", type: "mcq", question: "What does 'Chatur' mean in Marathi folk tales?", options: ["Four", "Clever / Smart", "Slow", "Angry"], answer: "Clever / Smart" },
    { id: "m4-q15", type: "mcq", question: "'Sun' and 'Saasu' are terms for:", options: ["Weather", "Family relatives (Daughter-in-law & Mother-in-law)", "Food", "Animals"], answer: "Family relatives (Daughter-in-law & Mother-in-law)" },
    { id: "m4-q16", type: "mcq", question: "Which drums are associated with Lavani and Tamasha?", options: ["Tabla", "Dholki", "Sitar", "Flute"], answer: "Dholki" },
    { id: "m4-q17", type: "mcq", question: "The word 'Lavani' comes from the Sanskrit 'Lavanya' meaning:", options: ["Power", "Beauty/Grace", "Speed", "Truth"], answer: "Beauty/Grace" },
    { id: "m4-q18", type: "mcq", question: "What is 'Pandharpur Wari'?", options: ["A shopping festival", "A devotional walking pilgrimage", "A war", "A school competition"], answer: "A devotional walking pilgrimage" },
    { id: "m4-q19", type: "mcq", question: "Translate 'झोप रे बाळा':", options: ["Eat, my child", "Sleep, my child", "Come, my child", "Play, my child"], answer: "Sleep, my child" },
    { id: "m4-q20", type: "mcq", question: "What is 'Sahyadri'?", options: ["A river", "A mountain range in Maharashtra", "A famous book", "A festival"], answer: "A mountain range in Maharashtra" },
    { id: "m4-q21", type: "mcq", question: "Who is the 'Adikavi' of Marathi (traditionally)?", options: ["Sant Tukaram", "Mukundraj / Dnyaneshwar period", "Shivaji Maharaj", "Nia"], answer: "Mukundraj / Dnyaneshwar period" },
    { id: "m4-q22", type: "mcq", question: "What does 'गड' (Gad) mean in fort names?", options: ["River", "Mountain-Fort", "Palace", "Forest"], answer: "Mountain-Fort" },
    { id: "m4-q23", type: "mcq", question: "What was the language of government before Shivaji's reforms?", options: ["English", "Persian", "Sanskrit", "Hindi"], answer: "Persian" },
    { id: "m4-q24", type: "mcq", question: "What is 'माहेर' (Maher)?", options: ["Market", "A girl's parental home (important in Marathi culture)", "School", "Temple"], answer: "A girl's parental home (important in Marathi culture)" },
    { id: "m4-q25", type: "mcq", question: "Which saint used the grocer's metaphor in his poems?", options: ["Dnyaneshwar", "Tukaram", "Namdev", "Chokhamela"], answer: "Tukaram" },
    { id: "m4-q26", type: "mcq", question: "'Gauri-Ganpati' is a major festival in:", options: ["Punjab", "Maharashtra", "Kerala", "Assam"], answer: "Maharashtra" },
    { id: "m4-q27", type: "mcq", question: "What is 'Puran Poli'?", options: ["A spicy curry", "A sweet stuffed flatbread", "A type of rice", "A vegetable"], answer: "A sweet stuffed flatbread" },
    { id: "m4-q28", type: "mcq", question: "Which city is the cultural capital of Maharashtra?", options: ["Mumbai", "Pune", "Nagpur", "Nashik"], answer: "Pune" },
    { id: "m4-q29", type: "mcq", question: "The word 'Tamatsha' entered which language from Marathi/Persian?", options: ["Sanskrit", "English", "French", "Latin"], answer: "English" },
    { id: "m4-q30", type: "mcq", question: "Marathi is the ________ most spoken language in India.", options: ["First", "Second", "Third", "Tenth"], answer: "Third" }
  ]
};
